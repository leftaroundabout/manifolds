...
tests = testGroup "Tests"
 ...
 , testGroup "Neighbour-search for web knitting."
    ...
    , testCase "Best neighbours in point selection from almost-rectangular grid"
        $ bestNeighbours euclideanNorm ([]::[(ℝ,ℝ)])
           ((id *** (^-^(1.6499999999999992, 3.6000000000000014))) <$>
               [ (235,(1.6499999999999992, 3.4000000000000012))
               , (248,(0.8999999999999997, 3.6000000000000014))
               , (267,(1.6499999999999992, 3.8000000000000016))
               , (268,(1.7999999999999992, 3.6000000000000014))
               , (271,(1.4999999999999993, 3.6000000000000014))
               ])
          @?= ([268,235,271,267], Nothing)
    ]
 ]
